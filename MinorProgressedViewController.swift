    ...
    var mySunText = ""
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            cell.configure(signGlyphImageName: "\(minor_Signs[indexPath.row])", planetImageImageName: "\(planetImages2[indexPath.row])", signTextText: "\(minor_Signs[indexPath.row])", planetTextText: "\(h_Planets[indexPath.row])", headerTextText: "\(h_planets[indexPath.row])")
        ...
        func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            print(getMyProgressedPlanets(date: getMinors()
            )[indexPath.row])
