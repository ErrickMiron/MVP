//
//  NataNeptuneAspectsViewController.swift
//  MVP
//
...
class NatalNeptuneAspectsViewController: UIViewController {
  ...
  //
          ...
          planetIntro.frame = CGRect(x: 20, y: 0, width: 325, height: 100)
           planetIntro.text = "Any aspect of Neptune increases the imagination, increases the sensitivity, and attracts schemes."
          ...
          planetIntro1.text = "The Opportunity: The ability to experience serenity, inspiration, and transcendence in the face of life’s dramas; the ability to receive a Vision."
          ...
          planetIntro2.frame = CGRect(x: 20, y: 125, width: 325, height: 80)
           planetIntro2.text = "The Challenge: Can you intentionally enter an altered state of consciousness, opening your awareness to what we might call God or your deeper self?"
          ...
          planetIntro3.frame = CGRect(x: 20, y: 195, width: 325, height: 80)
           planetIntro3.text = "The Trap: The temptation to deceive or undo ourselves with glamorous falsehoods and easy, self-destructive patterns of escape."
          ...
          planetIntro4.frame = CGRect(x: 20, y: 260, width: 325, height: 80)
           planetIntro4.text = "The Lie: Eat, drink, and be merry, for tomorrow you may die."
  ...
  extension NatalNeptuneAspectsViewController: UITableViewDataSource, UITableViewDelegate {
      func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
          return getNatalNeptuneAspects().count
      }
