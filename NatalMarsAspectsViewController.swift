//
//  NatalMarsAspectsViewController.swift
//  MVP
//
...
class NatalMarsAspectsViewController: UIViewController {
...
//
        ...
        planetIntro.frame = CGRect(x: 20, y: 0, width: 325, height: 100)
         planetIntro.text = "Any aspect of Mars brings strife, haste, and increased expenditure of energy."
        ...
        planetIntro1.text = "The Opportunity: The ability to act decisively, moving onto the offensive, defending our rightful territory, and claiming what is legitimately our own. "
        ...
        planetIntro2.frame = CGRect(x: 20, y: 125, width: 325, height: 80)
         planetIntro2.text = "The Challenge: Are you brave enough to live like a “spiritual warrior”—or will you sit back and let life steamroller you?"
        ...
        planetIntro3.frame = CGRect(x: 20, y: 190, width: 325, height: 80)
         planetIntro3.text = "The Trap: The temptation to “kick the dog,” while collapsing into fear, denial, and feelings of victimization."
        ...
        planetIntro4.frame = CGRect(x: 20, y: 235, width: 325, height: 80)
         planetIntro4.text = "The Lie: Screw them before they screw you."
...
extension NatalMarsAspectsViewController: UITableViewDataSource, UITableViewDelegate {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return getNatalMarsAspects().count
    }
