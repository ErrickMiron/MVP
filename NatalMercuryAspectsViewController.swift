//
//  NatalMercuryAspectsViewController.swift
//  MVP
//
...
class NatalMercuryAspectsViewController: UIViewController {
...
//
        planetIntro.frame = CGRect(x: 20, y: 0, width: 325, height: 100)
         planetIntro.text = "Any aspect of Mercury affects the mental interests, the facility or accuracy of expression, and increases the cerebral activity."
        ...
        planetIntro1.frame = CGRect(x: 20, y: 65, width: 325, height: 80)
        planetIntro1.text = "The Opportunity: The capacity to replace familiar but outdated pictures of the world with new ideas and points of view."
        ...
        planetIntro2.frame = CGRect(x: 20, y: 120, width: 325, height: 80)
         planetIntro2.text = "The Challenge: Can you grant yourself permission to see more clearly tomorrow than you do today?"
        ...
        planetIntro3.frame = CGRect(x: 20, y: 175, width: 325, height: 80)
         planetIntro3.text = "The Trap: The temptation to misdirect energy needed for learning and clarifying into rationalization, defensiveness, and intransigence."
        ...
        planetIntro4.frame = CGRect(x: 20, y: 230, width: 325, height: 80)
         planetIntro4.text = "The Lie: You’ve seen it all."
...
extension NatalMercuryAspectsViewController: UITableViewDataSource, UITableViewDelegate {
            func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
                return getNatalMercuryAspects().count
            }
