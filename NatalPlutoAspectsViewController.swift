//
//  NatalPlutoAspectsViewController.swift
//  MVP
//
...
class NatalPlutoAspectsViewController: UIViewController {
  ...
  //
          ...
          planetIntro.frame = CGRect(x: 20, y: 0, width: 325, height: 100)
           planetIntro.text = "Any aspect of Pluto affects through groups, through subtle force, and brings coercion or cooperation"
          ...
          planetIntro1.text = "The Opportunity: The ability to heal one’s soul, recovering the energy needed to find an altruistic mission in life, thereby filling one’s consciousness with a sense of ultimate purpose."
          ...
          planetIntro2.frame = CGRect(x: 20, y: 125, width: 325, height: 80)
           planetIntro2.text = "The Challenges: Can you face your deepest wounds and fears? Can you recognize some inner vision or gift that life has givene"
          ...
          planetIntro3.frame = CGRect(x: 20, y: 195, width: 325, height: 80)
           planetIntro3.text = "The Trap: The temptation to allow rigidity, dogmatism, and power-tripping to narrow our perspective, isolating our egos in a spirit of cynicism, despair, and nihilism. The compulsion to reenact whatever dramas have wounded us in the past."
          ...
          planetIntro4.frame = CGRect(x: 20, y: 260, width: 325, height: 80)
           planetIntro4.text = "The Lie: Look out for number one."
  ...
  extension NatalPlutoAspectsViewController: UITableViewDataSource, UITableViewDelegate {
      func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
          return getNatalPlutoAspects().count
      }
