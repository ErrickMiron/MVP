//
//  NatalSaturnAspectsViewController.swift
//  MVP
//
...
class NatalSaturnAspectsViewController: UIViewController {
...
//
        ...
        planetIntro.frame = CGRect(x: 20, y: 0, width: 325, height: 100)
         planetIntro.text = "Any aspect of Saturn brings work, responsibility, and economy or loss."
        ...
        planetIntro1.text = "The Opportunity: The ability to see reality clearly and to respond to it effectively and decisively."
        ...
        planetIntro2.frame = CGRect(x: 20, y: 125, width: 325, height: 80)
         planetIntro2.text = "The Challenge: Can you push aside wishful or fearful thinking and respond to concrete issues with self-discipline, patience, and practical strategies—and if necessary, can you do it alone?"
        ...
        planetIntro3.frame = CGRect(x: 20, y: 195, width: 325, height: 80)
         planetIntro3.text = "The Trap: The temptation to slip into despair and frustration when reality seems to turn against us."
        ...
        planetIntro4.frame = CGRect(x: 20, y: 245, width: 325, height: 80)
         planetIntro4.text = "The Lie: You can't win."
...
extension NatalSaturnAspectsViewController: UITableViewDataSource, UITableViewDelegate {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return getNatalSaturnAspects().count
    }
