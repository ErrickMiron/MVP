...
var mySunText = ""
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: CustomTableViewCell.identifier, for: indexPath) as? CustomTableViewCell else {
         ...
         cell.configure(signGlyphImageName: "\(mySigns[indexPath.row])", planetImageImageName: "\(planetImages2[indexPath.row])", signTextText: "\(r_Signs[indexPath.row])", planetTextText: "\(h_Planets[indexPath.row])", headerTextText: "\(h_planets[indexPath.row])")
...
//        
        ...
        var PlanetVCs = [SunViewController(),MoonViewController(),AscendantViewController(),MercuryViewController(),VenusViewController(),MarsViewController(),JupiterViewController(),SaturnViewController(),UranusViewController(),NeptuneViewController(),PlutoViewController()]
