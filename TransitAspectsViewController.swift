...
//  Just the Two of Us
    ...
    class TransitAspectsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
        ...
        func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
            return getTransitSunAspects().count
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            cell.configure(firstPlanetImageImageName: "uranus", secondPlanetImageImageName: "rising", firstSignTextText: "taurus", secondSignTextText: "virgo", secondPlanetTextText: "rising", firstPlanetTextText: "uranus",firstAspectHeaderTextText: "Individualistic Urges",secondAspectHeaderTextText: "Personal urges" )
